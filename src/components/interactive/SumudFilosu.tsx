        ...
        <motion.div variants={riseSettle} className="dossier-card rounded-2xl p-6">
          <div className="mb-5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-bone/15 bg-ink px-4 py-3 text-sm text-bone placeholder-bone/30 outline-none transition-colors focus:border-flag-green/50"
            />
          </div>
              ...
              {cargoOptions.map((opt) => (
                <label
                  ...
                  className={`flex cursor-pointer items-center gap-3 rounded-lg border px-4 py-3 text-sm transition-all ${
                    cargo === opt.value
                      ? 'border-flag-green/50 bg-flag-green/10 text-bone'
    ...
    return (
      ...
      >
        <motion.div variants={riseSettle} className="mb-10">
          ...
          <h2 className="riso-title mb-4 text-2xl font-black text-bone">
            {t('epilogue_title')}
          </h2>
        ...
        >
          ...
          <span className="text-bone">{shipName}</span>
        ...
        <motion.div variants={fadeUp} className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full border border-bone/20 px-6 py-3 text-sm font-semibold text-bone-dim transition-colors hover:border-flag-red/40 hover:text-bone"
          >
        ...
        >
          ...
          <div className="mb-6 flex items-start gap-4">
            ...
            <div>
              ...
              <h2 className="text-xl font-black text-bone">{currentPhaseData.title}</h2>
            </div>
          </div>
